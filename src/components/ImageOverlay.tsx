...
export default function ImageOverlay({ isVisible, onClose, imagePath, title }: ImageOverlayProps) {
      ...
      {isVisible && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full h-full max-w-6xl max-h-[85vh] flex items-center justify-center p-3 md:p-4"
