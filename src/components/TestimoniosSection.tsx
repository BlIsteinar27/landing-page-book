...
const testimonios = [
  {
    ...
    inicial: 'M',
    color: 'hsl(20, 40%, 30%)',
    reseña: 'Este libro llegó a mi vida en el momento perfecto. Cada página me hizo reflexionar y tomar decisiones que han cambiado mi rumbo.',
    estrellas: 5,
  },
  {
    ...
    inicial: 'C',
    color: 'hsl(35, 35%, 28%)',
    reseña: 'Victoria tiene una forma única de conectar con el lector. Me sentí acompañado en cada capítulo y las herramientas son realmente prácticas.',
    estrellas: 5,
  },
  {
    nombre: 'Ana Martínez',
    ...
    inicial: 'A',
    color: 'hsl(12, 45%, 32%)',
    reseña: 'Lo leí en una tarde y ya lo he recomendado a todos mis amigos. Es una guía que vale la pena tener siempre cerca.',
    estrellas: 5,
  },
];
